...
class Trainer(object):
    ...
    def combine_heads(self, outputs, target):
        ...
        具体写法请按你项目中的规则来，比如:
         normal_scores -> 取负号
         ab_scores, pseudo_scores, comparison_scores -> 正向相加
        """
...
def main():
    ...
    parser.add_argument('--classname', type=str, default='toothbrush', help="dataset class")
