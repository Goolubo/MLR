...
if __name__ == '__main__':
    ...
    parser.add_argument("--ramdn_seed", type=int, default=seed, help="the random seed number")
    parser.add_argument('--workers', type=int, default=4, metavar='N', help='dataloader threads')
    parser.add_argument('--no-cuda', action='store_true', default=False, help='disables CUDA training')
    parser.add_argument('--savename', type=str, default='model.pkl', help="save modeling")
    parser.add_argument('--dataset_root', type=str, default='D:\\student\\shyx\\ad', help="dataset root")
    parser.add_argument('--experiment_dir', type=str, default='./experiment/carpet', help="dataset root")
    ...
    roc_auc, ap=trainer.eval()
    
    print('args.nAnomaly:',args.nAnomaly)
    
    #with open(args.experiment_dir + '/auc-convlinear-allrd{}-nr{}-na{}-{}.txt'.format(seed,args.nRef,nanam,args.know_class), 'w') as f:
    with open(args.experiment_dir + '/auc-onlybi-allrd{}-nr{}-na{}.txt'.format(seed,args.nRef,nanam), 'w') as f:
        f.writelines(str(roc_auc) + '\n')
        f.writelines(str(ap) + '\n')
